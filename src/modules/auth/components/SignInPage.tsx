          ...
          <section className="w-full md:w-1/2 flex flex-col items-center justify-center bg-slate-50 dark:bg-[#0e0f13] relative z-10 px-4 py-2 overflow-hidden min-h-0">
            <div className="w-full max-w-[434px] flex flex-col justify-center">
              ...
              <div className="border border-slate-300 dark:border-[#272735] rounded-xl p-4 lg:p-6 flex flex-col justify-center bg-white dark:bg-[#0B0F17] shrink-0 w-full">
                ...
                {/* Email/Mobile field */}
                <div className="mt-6">
                  <label className="block mb-1.5 font-['Outfit',sans-serif] font-medium text-[13px] lg:text-[14px] text-slate-900 dark:text-[#f8f8fc]" htmlFor="identifier">
                ...
                <div className="mt-5">
                  <div className="flex items-center gap-1.5 mb-1.5">
                    <span className="font-['Outfit',sans-serif] font-medium text-[13px] lg:text-[14px] text-slate-900 dark:text-[#f8f8fc]">Password</span>
                  ...
                  <div className={`flex items-center bg-slate-50 dark:bg-[#08081a] border rounded px-3 h-10 lg:h-11 ${passError ? 'border-[#da4545]' : 'border-slate-300 dark:border-[#393948]'}`}>
                    <input
                      id="password"
                    ...
                    <button
                      type="button"
                      className="bg-transparent border-0 p-0 ml-2 cursor-pointer text-slate-500 dark:text-[#9c9ca3] flex items-center"
                ...
                >
                  ...
                  <span className="font-['Outfit',sans-serif] text-[14px] text-slate-900 dark:text-[#f8f8fc]">Keep me logged in</span>
                </button>
                  ...
                  {MESSAGES.map((_, idx) => (
                    <button
                      ...
                      className={`block h-[3px] border-0 p-0 rounded-full cursor-pointer transition-all duration-300 ${
                        idx === aspIndex ? 'w-[12px] bg-[#3355f6]' : 'w-[8px] bg-slate-50 dark:bg-white/40'
                      }`}
